...
const handleDeleteSelectedOrders = async () => {
  if (selectedOrders.length === 0) {
    toast.info("No orders selected for cancellation.", {
      type: 'warn',
      position: 'top-right'
    });
    return;
      ...
      <button
        onClick={async () => {
          try {
            ...
            if (res.status === 200) {
              toast.info("Selected orders cancelled successfully", {
                type: 'success',
                position: 'top-right'
              });
              getdata(); // Refresh the order list
              ...
              toast.info("Failed to cancel selected orders.", {
                type: 'error',
                position: 'top-right'
              });
            }
            ...
            toast.info("Failed to cancel selected orders. Please try again.", {
              type: 'error',
              position: 'top-right'
            });
          }
